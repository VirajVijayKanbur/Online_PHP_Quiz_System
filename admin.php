...
var dotpos = x.lastIndexOf(".");if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length) { alert("Not a valid e-mail address.");return false;}var a = document.forms["form"]["password"].value;if(a == null || a == ""){
alert("Password must be filled out");return false;}if(a.length<5 || a.length>25){alert("Passwords must be 5 to 25 characters long.");return false;}
...
{
font: 400 15px Lato, sans-serif; line-height: 1.8;
color: #818181;
}
h2 {
font-size: 24px;
...
h4 {
font-size: 19px;
line-height: 1.375em; color: #303030;
...
.jumbotron {
background-color: #f4511e; color: #fff;
padding: 100px 25px;
...
.logo {
color: #f4511e; font-size: 200px;
}

.thumbnail {
padding: 0 0 15px 0; border: none; border-radius: 0;
}
...
.item h4 {
font-size: 19px;
line-height: 1.375em; font-weight: 400; font-style: italic; margin: 70px 0;
}
.item span {
font-style: normal;
}
.panel {
border: 1px solid #f4511e; border-radius:0 !important; transition: box-shadow 0.5s;
}
.panel:hover {
box-shadow: 5px 0px 40px rgba(0,0,0, .2);
}
.panel-footer .btn:hover { border: 1px solid #f4511e;
background-color: #fff !important; color: #f4511e;
}
.panel-heading {
color: #fff !important;
background-color: #f4511e !important; padding: 25px;
...
background-color: #f4511e; z-index: 9999;
border: 0;

font-size: 12px !important;
line-height: 1.42857143 !important; letter-spacing: 4px;
border-radius: 0;
font-family: Montserrat, sans-serif;
}
.navbar li a, .navbar .navbar-brand { color: #f4511e !important;
}
.navbar-nav li a:hover, .navbar-nav li.active a { color: #f4511e !important;
...
margin-bottom: 20px; color: #f4511e;
}
.slideanim {visibility:hidden;}
.slide {
animation-name: slide;
-webkit-animation-name: slide; animation-duration: 1s;
...
<h4><strong>MISSION:</strong> My Mission is to make people test their sport knowledge online for free </h4><br>
<p><strong>VISION:</strong> Free knowledge testing without wasting paper,hence ECO frindly.</p>
</div>
...
<h4>Sport Examination MCQ format</h4>
...
<h4>ACCESSIBLE BY EVERYONE WITH INTERNET</h4>
<p>Enthusiasm shown by people in sports is my satisfaction.</p>
</div>
</div>
<br><br>
<div class="row slideanim">
...
<h4 style="color:#303030;">CONTACT ME</h4>
...
<div class="col-sm-4">
<div class="thumbnail">
<p><strong>Viraj Vijay Kanbur</strong></p>
<p>VIT Vellore 2nd year BTECH</p>
</div>
</div>
...
<h4>"Great job Viru"<br><span>Nikhil Bharadwaj,VIT Vellore, 2nd ECE</span></h4>
</div>
<div class="item">
<h4>"AILAAA"<br><span>Sachin Tendulkar, GOD OF CRICKET</span></h4>
</div>
<div class="item">
<h4>"Whistle Podu"<br><span>MS Dhoni, Indian Cricketer</span></h4>
</div>
</div>
...
<div class="col-sm-8">
<h2>About Page</h2><br>
<h4>Simple, free SPORTS quiz with no wastage of paper just requiring internet connection.</h4><br>
<p>Online Examination System (OES) is a platform to hold online examination.The system makes it possible to maintain a database of questions and provide error free marking.</p>

<br><button class="btn btn-default btn-lg">Be in touch</button>
</div>
<div class="col-sm-4">
...
<p><span class="glyphicon glyphicon-phone"></span> +91 8082523899 </p>
<p><span class="glyphicon glyphicon-envelope"></span> viraj.k@hotmail.com</p>
</div>
...
<script>
function myMap() {
var myCenter = new google.maps.LatLng(12.9721, 79.1596);
var mapProp = {center:myCenter, zoom:12, scrollwheel:false, draggable:false, mapTypeId:google.maps.MapTypeId.ROADMAP};
var map = new google.maps.Map(document.getElementById("googleMap"),mapProp); var marker = new google.maps.Marker({position:myCenter});
 
marker.setMap(map);
}
</script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCFj4gNzJYXg7z8mlzs0fHLKvi1MA ZYI3c&callback=myMap"></script>
...
$(".slideanim").each(function(){ var pos = $(this).offset().top;

var winTop = $(window).scrollTop(); if (pos < winTop + 600) {
$(this).addClass("slide");
}
